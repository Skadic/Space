...
public class ViewHolderTaskDrug extends RecyclerView.ViewHolder {
    public View view;
    ...
    public ViewHolderTaskDrug(Context context, View view) {
        super(view);
        this.view = view;
    ...
    public void setItem(final EnumTasks task, final OnItemClickListener listener) {
        tv_main.setText("Medikament");
        iv_barcode.setImageResource(R.drawable.ic_qrcode);
